    ...
    def build_system_prompt(
        ...
        *,
        ...
        return (
            ...
            "2. Use setup private tools to update SetupWorkspace drafts.\n"
            "3. Use read-only memory tools only when needed for clarification or archival lookup.\n"
            "4. Ask clarifying questions when important fields are ambiguous.\n"
            "5. Do not invent facts casually.\n"
            "6. When the current step is sufficiently converged, call setup.proposal.commit.\n"
            "7. Never call proposal.submit or any memory write tool.\n"
            "8. Keep replies user-facing and concise.\n"
            "9. If a prior commit proposal for the current step was rejected, do not "
            "re-propose commit unless the user explicitly asks. Refine the draft based "
            "on the user's feedback first.\n"
            "10. If a setup tool call fails, read the tool error carefully. "
            ...
            "11. If the runtime says user-exclusive information is still missing, your next "
            "visible reply must ask that question explicitly. Do not pretend the turn is complete.\n"
            "12. Before calling setup.proposal.commit, self-check whether key open questions "
