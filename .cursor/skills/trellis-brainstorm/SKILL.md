...
```powershell
$taskDir = python .\.trellis\scripts\task.py create "brainstorm: <short goal>" --slug <auto>
```
...
```powershell
# Create child tasks
$child1 = python .\.trellis\scripts\task.py create "Child task 1" --slug child1 --parent $taskDir
$child2 = python .\.trellis\scripts\task.py create "Child task 2" --slug child2 --parent $taskDir

# Or link existing tasks
python .\.trellis\scripts\task.py add-subtask $taskDir $childDir
```
