...
Usage:
    ...
    python .\.trellis\scripts\task.py archive <task-name>         # Archive completed task
    python .\.trellis\scripts\task.py list                        # List active tasks
    python .\.trellis\scripts\task.py list-archive [month]        # List archived tasks
    python .\.trellis\scripts\task.py add-subtask <parent-dir> <child-dir>     # Link child to parent
    python .\.trellis\scripts\task.py remove-subtask <parent-dir> <child-dir>  # Unlink child from parent
"""
...
Usage:
  ...
  python .\.trellis\scripts\task.py set-scope <dir> <scope>            Set scope for PR title
  python .\.trellis\scripts\task.py archive <task-name>                Archive completed task
  python .\.trellis\scripts\task.py add-subtask <parent> <child>       Link child task to parent
  python .\.trellis\scripts\task.py remove-subtask <parent> <child>    Unlink child from parent
  python .\.trellis\scripts\task.py list [--mine] [--status <status>]  List tasks
  python .\.trellis\scripts\task.py list-archive [YYYY-MM]             List archived tasks
...
Examples:
  python .\.trellis\scripts\task.py create "Add login feature" --slug add-login
  python .\.trellis\scripts\task.py create "Add login feature" --slug add-login --package cli
  python .\.trellis\scripts\task.py create "Child task" --slug child --parent .trellis\tasks\01-21-parent
  ...
  python .\.trellis\scripts\task.py remove-subtask parent-task child-task
  python .\.trellis\scripts\task.py list                               # List all active tasks
  python .\.trellis\scripts\task.py list --mine                        # List my tasks only
  python .\.trellis\scripts\task.py list --mine --status in_progress   # List my in-progress tasks
""")
