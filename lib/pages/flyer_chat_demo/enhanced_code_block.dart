...
// 代码高亮主题直接使用 flutter_highlight 的主题
// vs2015Theme (暗色) 和 githubTheme (亮色)
...
class _EnhancedCodeBlockState extends State<_EnhancedCodeBlock> {
          ...
          if (widget.isStreaming) ...[
            ...
            SizedBox(
              ...
              child: CircularProgressIndicator(
                strokeWidth: 1.5,
                color: widget.isDark ? Colors.blue.shade300 : Colors.blue.shade600,
              ),
            ),
          ],
          const Spacer(),
  ...
  /// 构建带语法高亮的 TextSpan（用于 Text.rich，可被 SelectionArea 选中）
  TextSpan _buildHighlightedSpan(String code, TextStyle baseStyle, Map<String, TextStyle> theme) {
    Result result;
  ...
  /// 递归处理高亮节点
  void _processNode(Node node, List<TextSpan> spans, Map<String, TextStyle> theme, TextStyle baseStyle) {
    if (node.value != null) {
  ...
  Widget _buildCodeContentInternal() {
    ...
    if (_cachedCode != widget.code || _cachedLanguage != resolvedLanguage || _cachedIsDark != widget.isDark) {
                  ...
                  SelectionContainer.disabled(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: lineNumbers.map((lineNum) => Text(
                          lineNum,
